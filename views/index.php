...
<body style="height:100vh;" class="d-flex justify-content-center align-items-center">
    <div class="card border-light w-75">
        ...
        <div class="card-body">
            <!-- form login -->
            <form method="POST" action="../functions/back_login.php">
                <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" name="txt_email" aria-describedby="Ingresar email">
                </div>
